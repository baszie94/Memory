...
class HXCPP_CLASS_ATTRIBUTES  ImageDataUtil_obj : public hx::Object{
	...
	public:
		...
		static int threshold( ::lime::graphics::Image destImage,::lime::graphics::Image sourceImage,::lime::math::Rectangle sourceRect,::lime::math::Vector2 destPoint,::String operation,int threshold,hx::Null< int >  color,hx::Null< int >  mask,hx::Null< bool >  copySource);
		static Dynamic threshold_dyn();

		static int __threshold_inner_loop( ::lime::graphics::Image image,::lime::graphics::Image sourceImage,::lime::math::Rectangle sourceRect,int mask,int threshold,int operation,int color,int startX,int startY,int destWidth,int destHeight);
		static Dynamic __threshold_inner_loop_dyn();
		...
		static int lime_image_data_util_threshold_inner_loop( Dynamic image,::lime::graphics::Image sourceImage,Dynamic sourceRect,int mask,int threshold,int operation,int color,Dynamic destRect);
		static Dynamic lime_image_data_util_threshold_inner_loop_dyn();
		...
		static ::cpp::Function< int ( ::hx::Object * ,::hx::Object * ,::hx::Object * ,int ,int ,int ,int ,::hx::Object * ) > cffi_lime_image_data_util_threshold_inner_loop;
