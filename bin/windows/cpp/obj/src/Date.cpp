...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",26,0x62506267)
HX_STACK_THIS(this)
...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",30,0x62506267)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",64,0x62506267)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
