...
Void ApplicationMain_obj::main( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",104,0x0780ded5)
				{
					...
					__result->Add(HX_HCSTRING("background","\xee","\x93","\x1d","\x26") , (int)1193046,false);
					...
					__result->Add(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02") , (int)900,false);
					...
					__result->Add(HX_HCSTRING("title","\x98","\x15","\x3b","\x10") , HX_HCSTRING("Memory card game 3","\x56","\x25","\x0d","\xf9"),false);
					__result->Add(HX_HCSTRING("vsync","\xd1","\x2d","\xa8","\x3d") , false,false);
					__result->Add(HX_HCSTRING("width","\x06","\xb6","\x62","\xca") , (int)1800,false);
		...
		struct _Function_1_2{
			inline static Dynamic Block( Dynamic &tmp){
				...
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("build","\x2e","\xdb","\xea","\xba") , HX_HCSTRING("403","\x37","\x9f","\x27","\x00"),false);
					__result->Add(HX_HCSTRING("company","\x3d","\x15","\x69","\x83") , HX_HCSTRING("Bas Benjamins","\xd7","\x00","\xce","\x27"),false);
					__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("Memorycardgame3","\xf0","\xa4","\xb3","\x67"),false);
					__result->Add(HX_HCSTRING("fps","\xe9","\xc7","\x4d","\x00") , (int)60,false);
					__result->Add(HX_HCSTRING("name","\x4b","\x72","\xff","\x48") , HX_HCSTRING("Memory card game 3","\x56","\x25","\x0d","\xf9"),false);
					__result->Add(HX_HCSTRING("orientation","\xd0","\xee","\xfe","\xfd") , HX_HCSTRING("landscape","\x3b","\x78","\xad","\xfc"),false);
					__result->Add(HX_HCSTRING("packageName","\xf1","\x04","\xad","\x04") , HX_HCSTRING("Memorycardgame3","\xf0","\xa4","\xb3","\x67"),false);
