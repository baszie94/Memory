...
{
HX_STACK_FRAME("cpp.vm.Deque","new",0xa6685326,"cpp.vm.Deque.new","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Deque.hx",27,0x0435da34)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_FRAME("cpp.vm.Deque","add",0xa65e74e7,"cpp.vm.Deque.add","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Deque.hx",31,0x0435da34)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(31)
...
Dynamic Deque_obj::pop( bool block){
	HX_STACK_FRAME("cpp.vm.Deque","pop",0xa669e057,"cpp.vm.Deque.pop","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Deque.hx",36,0x0435da34)
	HX_STACK_THIS(this)
