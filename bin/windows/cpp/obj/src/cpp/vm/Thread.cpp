...
int Thread_obj::__compare( Dynamic t){
	HX_STACK_FRAME("cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",65,0x1f61cdde)
	HX_STACK_THIS(this)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(66)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",52,0x1f61cdde)
