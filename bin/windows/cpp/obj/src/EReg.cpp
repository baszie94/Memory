...
::String EReg_obj::replace( ::String s,::String by){
	HX_STACK_FRAME("EReg","replace",0xae923ad5,"EReg.replace","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",98,0xeadb2946)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(by,"by")
	HX_STACK_LINE(99)
...
struct _Function_0_1{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",174,0xeadb2946)
		{
			HX_STACK_LINE(174)
...
struct _Function_0_2{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",175,0xeadb2946)
		{
			HX_STACK_LINE(175)
...
struct _Function_0_3{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",177,0xeadb2946)
		{
			HX_STACK_LINE(177)
