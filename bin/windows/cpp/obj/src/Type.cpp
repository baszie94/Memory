...
::hx::Class Type_obj::getSuperClass( ::hx::Class c){
	HX_STACK_FRAME("Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",52,0x469e255b)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(53)
...
Dynamic Type_obj::createEmptyInstance( ::hx::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",86,0x469e255b)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,cpp::ArrayBase params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",90,0x469e255b)
	HX_STACK_ARG(e,"e")
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Type","enumEq",0x855650e1,"Type.enumEq","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",128,0x469e255b)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(129)
...
cpp::ArrayBase Type_obj::enumParameters( Dynamic e){
	HX_STACK_FRAME("Type","enumParameters",0xf9e1b41f,"Type.enumParameters","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",136,0x469e255b)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(137)
