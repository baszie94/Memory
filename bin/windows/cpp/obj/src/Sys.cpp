...
Array< ::String > Sys_obj::args( ){
	HX_STACK_FRAME("Sys","args",0xeaeddc7e,"Sys.args","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",50,0x85f8069a)
	HX_STACK_LINE(50)
	return ::__get_args();
}
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","F:\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",109,0x85f8069a)
