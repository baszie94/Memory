...
int length = __o_length.Default(0);
{
	...
	HX_STACK_LINE(251)
	this->__endian = HX_HCSTRING("bigEndian","\x7b","\xd5","\x5a","\x20");
	HX_STACK_LINE(252)
	this->position = (int)0;
}
;
...
Void ByteArrayData_obj::compress( ::openfl::utils::CompressionAlgorithm algorithm){
{
		...
		HX_STACK_LINE(275)
		bool tmp1 = (algorithm == ::openfl::utils::CompressionAlgorithm_obj::LZMA);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(275)
		if ((tmp1)){
			HX_STACK_LINE(277)
...
int ByteArrayData_obj::readInt( ){
	...
	HX_STACK_LINE(418)
	::String tmp4 = this->__endian;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(418)
	bool tmp5 = (tmp4 == HX_HCSTRING("littleEndian","\x31","\x2e","\x7b","\x07"));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(418)
	if ((tmp5)){
		HX_STACK_LINE(420)
...
int ByteArrayData_obj::readShort( ){
	...
	HX_STACK_LINE(445)
	::String tmp2 = this->__endian;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(445)
	bool tmp3 = (tmp2 == HX_HCSTRING("littleEndian","\x31","\x2e","\x7b","\x07"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(445)
	if ((tmp3)){
		HX_STACK_LINE(447)
...
Void ByteArrayData_obj::uncompress( ::openfl::utils::CompressionAlgorithm algorithm){
{
		...
		if ((tmp)){
			HX_STACK_LINE(551)
			algorithm = ::openfl::utils::CompressionAlgorithm_obj::GZIP;
		}
		HX_STACK_LINE(555)
		bool tmp1 = (algorithm == ::openfl::utils::CompressionAlgorithm_obj::LZMA);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(555)
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeBoolean",0x790a5b77,"openfl.utils.ByteArrayData.writeBoolean","openfl/utils/ByteArray.hx",589,0xaa5cee4a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeByte",0x6d0ba6d9,"openfl.utils.ByteArrayData.writeByte","openfl/utils/ByteArray.hx",596,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(598)
		int tmp = this->position;		HX_STACK_VAR(tmp,"tmp");
...
int offset = __o_offset.Default(0);
int length = __o_length.Default(0);
	HX_STACK_FRAME("openfl.utils.ByteArrayData","writeBytes",0xfd26577a,"openfl.utils.ByteArrayData.writeBytes","openfl/utils/ByteArray.hx",604,0xaa5cee4a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_ARG(offset,"offset")
	HX_STACK_ARG(length,"length")
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeDouble",0x8fc20922,"openfl.utils.ByteArrayData.writeDouble","openfl/utils/ByteArray.hx",617,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(619)
		int tmp = this->position;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeFloat",0x422514ab,"openfl.utils.ByteArrayData.writeFloat","openfl/utils/ByteArray.hx",626,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(628)
		int tmp = this->position;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeInt",0x83612a3e,"openfl.utils.ByteArrayData.writeInt","openfl/utils/ByteArray.hx",635,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(637)
		int tmp = this->position;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeMultiByte",0xebbf88b0,"openfl.utils.ByteArrayData.writeMultiByte","openfl/utils/ByteArray.hx",658,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_ARG(charSet,"charSet")
		HX_STACK_LINE(660)
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeShort",0xbbb5d38b,"openfl.utils.ByteArrayData.writeShort","openfl/utils/ByteArray.hx",665,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(667)
		int tmp = this->position;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUnsignedInt",0xcb6d2f49,"openfl.utils.ByteArrayData.writeUnsignedInt","openfl/utils/ByteArray.hx",684,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(686)
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUTF",0x836a2e76,"openfl.utils.ByteArrayData.writeUTF","openfl/utils/ByteArray.hx",691,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(693)
		::String tmp = value;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","writeUTFBytes",0xc5d11e15,"openfl.utils.ByteArrayData.writeUTFBytes","openfl/utils/ByteArray.hx",701,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(703)
		::String tmp = value;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","__fromBytes",0x684ac753,"openfl.utils.ByteArrayData.__fromBytes","openfl/utils/ByteArray.hx",709,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bytes,"bytes")
		HX_STACK_LINE(711)
		{
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","__resize",0x101b8202,"openfl.utils.ByteArrayData.__resize","openfl/utils/ByteArray.hx",717,0xaa5cee4a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.utils.ByteArrayData","__setData",0xac6a7b1e,"openfl.utils.ByteArrayData.__setData","openfl/utils/ByteArray.hx",736,0xaa5cee4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bytes,"bytes")
		HX_STACK_LINE(738)
		this->b = bytes->b;
...
int ByteArrayData_obj::get_bytesAvailable( ){
	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_bytesAvailable",0x68329f15,"openfl.utils.ByteArrayData.get_bytesAvailable","openfl/utils/ByteArray.hx",755,0xaa5cee4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(757)
...
::String ByteArrayData_obj::get_endian( ){
	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_endian",0x95dc5cd2,"openfl.utils.ByteArrayData.get_endian","openfl/utils/ByteArray.hx",762,0xaa5cee4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(764)
	::String tmp = this->__endian;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(764)
	return tmp;
}
...
::String ByteArrayData_obj::set_endian( ::String value){
	HX_STACK_FRAME("openfl.utils.ByteArrayData","set_endian",0x9959fb46,"openfl.utils.ByteArrayData.set_endian","openfl/utils/ByteArray.hx",769,0xaa5cee4a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(771)
	::String tmp = this->__endian = value;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(771)
	return tmp;
}
...
Dynamic ByteArrayData_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__endian") ) { __endian=inValue.Cast< ::String >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsString,(int)offsetof(ByteArrayData_obj,__endian),HX_HCSTRING("__endian","\xbb","\x03","\xb8","\xa2")},
