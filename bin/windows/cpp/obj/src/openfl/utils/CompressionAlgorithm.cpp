...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.utils.CompressionAlgorithm","\xc4","\xe9","\xab","\x59"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
