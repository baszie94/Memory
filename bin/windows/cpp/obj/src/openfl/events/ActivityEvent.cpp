...
::openfl::events::Event ActivityEvent_obj::clone( ){
	...
	HX_STACK_LINE(27)
	::openfl::events::EventPhase tmp7 = this->eventPhase;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(27)
...
bool ActivityEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"ACTIVITY") ) { outValue = ACTIVITY; return true;  }
	}
	return false;
}
...
bool ActivityEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"ACTIVITY") ) { ACTIVITY=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
