...
Dynamic Memory_obj::_setPositionTemporarily( int position,Dynamic action){
	...
	HX_STACK_LINE(17)
	::openfl::utils::ByteArrayData tmp = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(17)
	int oldPosition = tmp->position;		HX_STACK_VAR(oldPosition,"oldPosition");
	HX_STACK_LINE(18)
	::openfl::utils::ByteArrayData tmp1 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(18)
	...
	HX_STACK_LINE(20)
	::openfl::utils::ByteArrayData tmp3 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(20)
...
Void Memory_obj::select( ::openfl::utils::ByteArrayData inBytes){
{
		...
		if ((tmp)){
			HX_STACK_LINE(91)
			::openfl::utils::ByteArrayData tmp2 = inBytes;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(91)
			tmp1 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(tmp2);
		}
		else{
			HX_STACK_LINE(91)
			tmp1 = (int)0;
