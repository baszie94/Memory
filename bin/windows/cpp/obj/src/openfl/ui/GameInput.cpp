		...
		if ((tmp3)){
			...
			HX_STACK_LINE(167)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(169)
					::String tmp11 = ::openfl::events::GameInputEvent_obj::DEVICE_REMOVED;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(169)
					::openfl::ui::GameInputDevice tmp12 = device;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(169)
					::openfl::events::GameInputEvent tmp13 = ::openfl::events::GameInputEvent_obj::__new(tmp11,null(),null(),tmp12);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(169)
					instance->dispatchEvent(tmp13);
				}
			}
		}
	}
