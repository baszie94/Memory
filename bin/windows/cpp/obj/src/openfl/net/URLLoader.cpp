					...
					if ((tmp5)){
						HX_STACK_LINE(116)
						{
							...
							switch( (int)(_g1->__Index())){
								...
								default: {
									HX_STACK_LINE(119)
									::openfl::utils::ByteArrayData tmp6 = bytes;		HX_STACK_VAR(tmp6,"tmp6");
									HX_STACK_LINE(119)
									int tmp7 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
									HX_STACK_LINE(119)
									::String tmp8 = bytes->readUTFBytes(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
									HX_STACK_LINE(119)
									_g->data = tmp8;
								}
							}
					...
					HX_STACK_LINE(440)
					{
						...
						switch( (int)(_g1->__Index())){
							...
							default: {
								...
								HX_STACK_LINE(449)
								::openfl::utils::ByteArrayData tmp28 = _g->__data;		HX_STACK_VAR(tmp28,"tmp28");
								HX_STACK_LINE(449)
								int tmp29 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(tmp28);		HX_STACK_VAR(tmp29,"tmp29");
								HX_STACK_LINE(449)
								::String tmp30 = _g->__data->readUTFBytes(tmp29);		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(449)
								_g->data = tmp30;
								HX_STACK_LINE(450)
								_g->data->__FieldRef(HX_HCSTRING("position","\xa9","\xa0","\xfa","\xca")) = (int)0;
							}
						}
					}
					HX_STACK_LINE(454)
...
int URLLoader_obj::writeFunction( ::lime::utils::Bytes output,int size,int nmemb){
	...
	HX_STACK_LINE(474)
	::lime::utils::Bytes tmp1 = output;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(474)
...
int URLLoader_obj::headerFunction( ::lime::utils::Bytes output,int size,int nmemb){
...
Void URLLoader_obj::onStatus( int status){
{
		...
		HX_STACK_LINE(589)
		::openfl::events::HTTPStatusEvent tmp2 = ::openfl::events::HTTPStatusEvent_obj::__new(tmp,false,false,tmp1,null());		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(589)
