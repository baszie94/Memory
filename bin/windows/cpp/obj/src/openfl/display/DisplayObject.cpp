...
Void DisplayObject_obj::__updateTransforms( ::openfl::geom::Matrix overrideTransform){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(929)
			tmp2 = ::openfl::geom::Matrix_obj::__new(overrideTransform->a,overrideTransform->b,overrideTransform->c,overrideTransform->d,overrideTransform->tx,overrideTransform->ty);
		}
		else{
			HX_STACK_LINE(929)
