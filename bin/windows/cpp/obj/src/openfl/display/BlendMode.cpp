...
::openfl::display::BlendMode BlendMode_obj::SHADER;
...
int BlendMode_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_HCSTRING("SHADER","\x25","\x6b","\xa3","\xcf")) return 13;
	if (inName==HX_HCSTRING("SUBTRACT","\x14","\x05","\x97","\x51")) return 14;
...
int BlendMode_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_HCSTRING("SHADER","\x25","\x6b","\xa3","\xcf")) return 0;
...
Dynamic BlendMode_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_HCSTRING("SHADER","\x25","\x6b","\xa3","\xcf")) return SHADER;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(BlendMode_obj::SHADER,"SHADER");
...
static void sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(BlendMode_obj::SHADER,"SHADER");
...
hx::Static(SHADER) = hx::CreateEnum< BlendMode_obj >(HX_HCSTRING("SHADER","\x25","\x6b","\xa3","\xcf"),13);
hx::Static(SUBTRACT) = hx::CreateEnum< BlendMode_obj >(HX_HCSTRING("SUBTRACT","\x14","\x05","\x97","\x51"),14);
}
