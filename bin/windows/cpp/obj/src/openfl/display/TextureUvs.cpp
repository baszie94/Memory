...
{
HX_STACK_FRAME("openfl.display.TextureUvs","new",0xe69f4b33,"openfl.display.TextureUvs.new","openfl/display/BitmapData.hx",1681,0xdd12d5b9)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(1691)
	this->y3 = ((Float)0);
...
{
		HX_STACK_FRAME("openfl.display.TextureUvs","reset",0x93065f62,"openfl.display.TextureUvs.reset","openfl/display/BitmapData.hx",1693,0xdd12d5b9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1694)
