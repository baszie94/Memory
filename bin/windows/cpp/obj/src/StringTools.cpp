...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",36,0xb453944a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(44)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",61,0xb453944a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(69)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",127,0xb453944a)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",183,0xb453944a)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",200,0xb453944a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(204)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",225,0xb453944a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(229)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(230)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",247,0xb453944a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(253)
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","F:\\HaxeToolkit\\haxe\\std/StringTools.hx",334,0xb453944a)
	HX_STACK_ARG(n,"n")
