...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",713,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",725,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(727)
