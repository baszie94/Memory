...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","new",0x51c6b8a3,"lime._backend.native._NativeApplication.SensorEventInfo.new","lime/_backend/native/NativeApplication.hx",875,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",886,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(888)
