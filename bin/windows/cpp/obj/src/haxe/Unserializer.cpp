...
{
		HX_STACK_FRAME("haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",124,0x0fc4c960)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(125)
...
Float Unserializer_obj::readFloat( ){
	HX_STACK_FRAME("haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",172,0x0fc4c960)
	HX_STACK_THIS(this)
	HX_STACK_LINE(173)
	int tmp = this->pos;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(173)
...
{
		HX_STACK_FRAME("haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",185,0x0fc4c960)
		HX_STACK_THIS(this)
		HX_STACK_ARG(o,"o")
		HX_STACK_LINE(186)
		while((true)){
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_FRAME("haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",200,0x0fc4c960)
	HX_STACK_THIS(this)
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_FRAME("haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",232,0x0fc4c960)
	HX_STACK_THIS(this)
	HX_STACK_LINE(233)
	{
		HX_STACK_LINE(233)
		...
		switch( (int)(tmp1)){
			...
			case (int)111: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",280,0x0fc4c960)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							return __result;
						}
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_FRAME("haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",459,0x0fc4c960)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(460)
