...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",52,0xaaecc0d1)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",55,0xaaecc0d1)
		HX_STACK_THIS(this)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",58,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(59)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",62,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(63)
...
bool IntMap_obj::remove( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",66,0xaaecc0d1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(67)
