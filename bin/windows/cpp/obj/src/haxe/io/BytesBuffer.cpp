...
{
HX_STACK_FRAME("haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",54,0xc23ddc89)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(54)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",191,0xc23ddc89)
	HX_STACK_THIS(this)
	HX_STACK_LINE(212)
