...
::String Path_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",114,0x7d56f2c3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
...
::String Path_obj::withoutDirectory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","F:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",134,0x7d56f2c3)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(135)
