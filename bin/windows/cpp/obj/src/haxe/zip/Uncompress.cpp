...
{
HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",28,0xe82ba0d5)
HX_STACK_THIS(this)
...
Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",32,0xe82ba0d5)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",36,0xe82ba0d5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",40,0xe82ba0d5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(41)
