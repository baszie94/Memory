...
{
HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",29,0x9354da0e)
HX_STACK_THIS(this)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",33,0x9354da0e)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",37,0x9354da0e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(38)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",41,0x9354da0e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
		Dynamic tmp = this->s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(42)
